...
export const PROFILE_SHAPES: ProfileShape[] = [
  { id: 'entry-diversified-full', wealthTier: 'ENTRY', assetRegisterPattern: 'DIVERSIFIED', answerPattern: 'FULL_ANSWERS', troubleZone: 'HORIZON_VOCAB_EDGE', floor: 2, weight: 1 },
  { id: 'entry-property-skipped', wealthTier: 'ENTRY', assetRegisterPattern: 'PROPERTY_HEAVY', answerPattern: 'OPTIONAL_SKIPPED', troubleZone: 'OPTIONAL_SECTION_SKIPPER', floor: 4, weight: 2 },
  { id: 'entry-cash-heavy-horizon-short', wealthTier: 'ENTRY', assetRegisterPattern: 'CASH_HEAVY_DEFENSIVE', answerPattern: 'HORIZON_SHORT', troubleZone: 'CAPITAL_PRESERVATION_BOUNDARY', floor: 4, weight: 2 },
  { id: 'core-diversified-full', wealthTier: 'CORE', assetRegisterPattern: 'DIVERSIFIED', answerPattern: 'FULL_ANSWERS', troubleZone: 'HORIZON_VOCAB_EDGE', floor: 3, weight: 2 },
  { id: 'core-equity-heavy-horizon-vlong', wealthTier: 'CORE', assetRegisterPattern: 'EQUITY_HEAVY', answerPattern: 'HORIZON_VERY_LONG', troubleZone: 'HORIZON_VOCAB_EDGE', floor: 3, weight: 2 },
  { id: 'core-concentrated-red-hold', wealthTier: 'CORE', assetRegisterPattern: 'CONCENTRATED_SINGLE_LINE', answerPattern: 'FULL_ANSWERS', troubleZone: 'HARD_OVERRIDE_NOT_SURE', floor: 4, weight: 3, redGateStance: 'HOLD_DELIBERATE' },
  { id: 'core-concentrated-red-reduce', wealthTier: 'CORE', assetRegisterPattern: 'CONCENTRATED_SINGLE_LINE', answerPattern: 'FULL_ANSWERS', troubleZone: 'HARD_OVERRIDE_NOT_SURE', floor: 4, weight: 3, redGateStance: 'REDUCE' },
  { id: 'core-concentrated-red-no-response', wealthTier: 'CORE', assetRegisterPattern: 'CONCENTRATED_SINGLE_LINE', answerPattern: 'FULL_ANSWERS', troubleZone: 'HARD_OVERRIDE_NOT_SURE', floor: 4, weight: 3, redGateStance: 'NO_RESPONSE' },
  { id: 'core-property-notsure-heavy', wealthTier: 'CORE', assetRegisterPattern: 'PROPERTY_HEAVY', answerPattern: 'HARD_OVERRIDE_NOT_SURE_HEAVY', troubleZone: 'HARD_OVERRIDE_NOT_SURE', floor: 4, weight: 3 },
  { id: 'core-alts-notsure-heavy', wealthTier: 'CORE', assetRegisterPattern: 'ALTS_CRYPTO_HEAVY', answerPattern: 'HARD_OVERRIDE_NOT_SURE_HEAVY', troubleZone: 'HARD_OVERRIDE_NOT_SURE', floor: 4, weight: 3 },
  { id: 'core-cross-border-db', wealthTier: 'CORE', assetRegisterPattern: 'DIVERSIFIED', answerPattern: 'FULL_ANSWERS', troubleZone: 'CROSS_BORDER_DB_PENSION', floor: 5, weight: 3 },
  { id: 'high-diversified-optional-skipped', wealthTier: 'HIGH', assetRegisterPattern: 'DIVERSIFIED', answerPattern: 'OPTIONAL_SKIPPED', troubleZone: 'OPTIONAL_SECTION_SKIPPER', floor: 4, weight: 2 },
  { id: 'high-equity-heavy-full', wealthTier: 'HIGH', assetRegisterPattern: 'EQUITY_HEAVY', answerPattern: 'FULL_ANSWERS', troubleZone: 'CAPITAL_PRESERVATION_BOUNDARY', floor: 3, weight: 2 },
  { id: 'high-cash-heavy-preservation-boundary', wealthTier: 'HIGH', assetRegisterPattern: 'CASH_HEAVY_DEFENSIVE', answerPattern: 'FULL_ANSWERS', troubleZone: 'CAPITAL_PRESERVATION_BOUNDARY', floor: 5, weight: 3 },
  { id: 'high-cross-border-db-notsure', wealthTier: 'HIGH', assetRegisterPattern: 'DIVERSIFIED', answerPattern: 'HARD_OVERRIDE_NOT_SURE_HEAVY', troubleZone: 'CROSS_BORDER_DB_PENSION', floor: 5, weight: 3 },
  { id: 'high-alts-crypto-full', wealthTier: 'HIGH', assetRegisterPattern: 'ALTS_CRYPTO_HEAVY', answerPattern: 'FULL_ANSWERS', troubleZone: 'HARD_OVERRIDE_NOT_SURE', floor: 3, weight: 2 },
  { id: 'uhnw-diversified-full', wealthTier: 'UHNW', assetRegisterPattern: 'DIVERSIFIED', answerPattern: 'FULL_ANSWERS', troubleZone: 'CROSS_BORDER_DB_PENSION', floor: 3, weight: 2 },
  { id: 'uhnw-property-heavy-optional-skipped', wealthTier: 'UHNW', assetRegisterPattern: 'PROPERTY_HEAVY', answerPattern: 'OPTIONAL_SKIPPED', troubleZone: 'OPTIONAL_SECTION_SKIPPER', floor: 3, weight: 2 },
  { id: 'uhnw-concentrated-red-hold', wealthTier: 'UHNW', assetRegisterPattern: 'CONCENTRATED_SINGLE_LINE', answerPattern: 'FULL_ANSWERS', troubleZone: 'HARD_OVERRIDE_NOT_SURE', floor: 3, weight: 2, redGateStance: 'HOLD_DELIBERATE' },
  { id: 'uhnw-alts-crypto-notsure', wealthTier: 'UHNW', assetRegisterPattern: 'ALTS_CRYPTO_HEAVY', answerPattern: 'HARD_OVERRIDE_NOT_SURE_HEAVY', troubleZone: 'HARD_OVERRIDE_NOT_SURE', floor: 3, weight: 2 },
];
