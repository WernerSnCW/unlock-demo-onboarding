        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="text-center mb-20 relative">
            ...
            <p className="text-xl text-[var(--muted-foreground)] max-w-3xl mx-auto leading-relaxed">
              Discover the next generation of investment intelligence through our carefully crafted demonstration ecosystem
            </p>
          </div>
            ...
            {[
              {
                ...
                subtitle: "CSV Intelligence",
                description: "Upload complex portfolio data and watch our AI instantly categorize, validate, and enrich your holdings with real-time market intelligence.",
              ...
              },
              {
                ...
                subtitle: "10-Question Analysis",
                description: "Advanced psychometric assessment that maps your investment DNA to proven archetypes, unlocking personalized risk scenarios.",
              ...
              {
                icon: Zap,
                title: "Live Demo Engine",
                subtitle: "Real-Time Synthesis",
                description: "Seamlessly combines your portfolio data with investor persona to deliver hyper-personalized market stress testing.",
                gradient: "from-orange-500 to-red-400",
                bgColor: "bg-orange-50 dark:bg-orange-950/20",
                borderColor: "border-orange-200 dark:border-orange-800/30"
              }
            ].map((feature, index) => (
              <div key={index} className={`relative group ${feature.bgColor} ${feature.borderColor} border rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2`}>
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-5 rounded-2xl`}></div>
                </div>
                
                <div className="relative z-10">
                  <div className={`inline-flex p-4 bg-gradient-to-br ${feature.gradient} text-white rounded-xl mb-6 group-hover:scale-110 transition-transform duration-300`}>
                    <feature.icon className="h-8 w-8" />
                  </div>
                  
                  <h3 className="text-2xl font-bold text-[var(--foreground)] mb-2">{feature.title}</h3>
                  <p className="text-sm font-semibold text-[var(--muted-foreground)] uppercase tracking-wider mb-4">{feature.subtitle}</p>
                  <p className="text-[var(--muted-foreground)] leading-relaxed">{feature.description}</p>
                  
                  <div className="flex items-center mt-6 text-[var(--primary)] font-medium group-hover:translate-x-2 transition-transform duration-300">
          ...
          {/* Call to Action - Premium Focus */}
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)] opacity-10 blur-2xl rounded-3xl"></div>
            <div className="relative bg-gradient-to-br from-[var(--card)] to-[var(--muted)] border border-[var(--border)] rounded-3xl p-12 text-center">
              <div className="flex items-center justify-center mb-6">
                <div className="relative">
                  <Crown className="h-16 w-16 text-[var(--primary)]" />
                  <div className="absolute -top-2 -right-2">
                    <Gift className="h-6 w-6 text-[var(--accent)] fill-current animate-bounce" />
                  </div>
                </div>
              </div>
              ...
              <p className="text-xl text-[var(--muted-foreground)] mb-8 max-w-2xl mx-auto">
                Join the exclusive preview of investment analysis reimagined for the AI era
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link href="/investor-onboarding" className="group">
                  <div className="relative bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)] text-white px-8 py-4 rounded-full font-bold text-lg shadow-2xl hover:shadow-[var(--primary)]/30 transition-all duration-300 group-hover:scale-105">
                    <div className="flex items-center gap-3">
                      <Users className="h-6 w-6" />
                      <span>Begin Demo Journey</span>
                ...
                <div className="flex items-center gap-2 text-[var(--muted-foreground)]">
                  ...
                  <span className="text-sm">Private Preview Access</span>
                </div>
              </div>
            </div>
          </div>
