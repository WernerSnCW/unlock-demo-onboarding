        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-2xl mx-auto pt-4">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white dark:bg-slate-800/80 rounded-2xl border border-[var(--border)] shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
              ...
              <div className="px-6 pt-10 pb-2">
                <h3 className="text-lg font-semibold text-[var(--foreground)]">Basic Details</h3>
              </div>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white dark:bg-slate-800/80 rounded-2xl border border-[var(--border)] shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
              ...
              <div className="px-6 pt-10 pb-2">
                <h3 className="text-lg font-semibold text-[var(--foreground)]">Financial Picture</h3>
              </div>
              <div className="p-6 pt-2">
              <div className="grid md:grid-cols-2 gap-4">
              <FormField
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white dark:bg-slate-800/80 rounded-2xl border border-[var(--border)] shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
              ...
              <div className="px-6 pt-10 pb-2">
                <h3 className="text-lg font-semibold text-[var(--foreground)]">Goals & Risk Profile</h3>
              </div>
              <div className="p-6 pt-2">
              <div className="grid md:grid-cols-2 gap-4">
              <FormField
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white dark:bg-slate-800/80 rounded-2xl border border-[var(--border)] shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
              ...
              <button
                ...
                className="w-full flex items-center justify-between px-6 pt-10 pb-4 hover:bg-[var(--muted)]/20 transition-colors"
                data-testid="toggle-investor-profile"
              >
                <div className="flex items-center gap-3">
                  <span className="text-lg font-semibold text-[var(--foreground)]">Investor Profile</span>
                  <span className="text-xs font-semibold px-3 py-1 rounded-full bg-gradient-to-r from-purple-500/20 to-purple-600/20 text-purple-600 dark:text-purple-400 border border-purple-500/30">Optional</span>
                </div>
              {showInvestorProfile ? (
