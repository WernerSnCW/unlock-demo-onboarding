...
const PersonaCard: React.FC<{ persona: PersonaDef; onClick: () => void }> = ({ persona, onClick }) => {
  return (
    <Card 
      className="cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-105 border-2 hover:border-[var(--primary)]"
      onClick={onClick}
    ...
    >
      <CardHeader className="pb-4">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <CardTitle className="text-lg font-bold text-[var(--card-foreground)] leading-tight">
              {persona.name}
            </CardTitle>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Badge className={getRiskProfileColor(persona.riskProfile)} variant="secondary">
            {persona.riskProfile}
          </Badge>
        </div>
