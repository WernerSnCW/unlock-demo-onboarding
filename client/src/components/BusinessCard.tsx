    ...
    <div className="bg-[var(--card)] border border-[var(--border)] rounded-[var(--radius-lg)] p-8 hover:shadow-xl hover:scale-[1.01] transition-all duration-300 relative overflow-hidden" style={{ boxShadow: 'var(--shadow-sm)' }}>
      ...
      <div className="flex gap-2">
        ...
        <div className="flex gap-2">
          {onToggleLike && (
            <button
              ...
              title={isLiked ? 'Unlike this business' : 'Like this business'}
            >
              <i className={`fas fa-thumbs-up ${isLiked ? 'text-blue-600 dark:text-blue-400' : ''}`} aria-hidden="true"></i>
            </button>
          )}
          {onToggleFavorite && (
            <button
            ...
            >
              <i className={`fas fa-heart ${isFavorited ? 'text-red-600 dark:text-red-400' : ''}`} aria-hidden="true"></i>
            </button>
          )}
        </div>
        ...
        <Link
          ...
          className="inline-flex items-center justify-center flex-1 px-4 py-2 bg-[#5193B3] hover:bg-[#4082a2] text-white text-sm font-medium rounded-lg transition-colors"
        >
          Open Profile
